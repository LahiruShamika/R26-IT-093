...
def dice_coef(y_true, y_pred, smooth=1e-6): # Dice coefficient for segmentation evaluation
...
BASE_DIR = "models" # Directory where all models and encoders are stored

SEG_MODEL_PATH = os.path.join(BASE_DIR, "best_seg_model.h5") # Segmentation model for cow body segmentation
REG_MODEL_PATH = os.path.join(BASE_DIR, "best_reg_model.h5") 
FEED_MODEL_PATH = os.path.join(BASE_DIR, "cow_feed_predictor.pkl") # Regression model for weight prediction and feed requirement prediction
...
seg_model = load_model( # Load segmentation model with custom dice coefficient
    SEG_MODEL_PATH,
